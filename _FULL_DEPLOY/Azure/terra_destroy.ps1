$logFilePath = "E:\Projects\Workshop_CICD\_FULL_DEPLOY\Azure\terraform_destroy_log.txt"
...
Write-Host -ForegroundColor Blue "Terraform destroy took $minutes minute(s) and $seconds second(s) to complete."
